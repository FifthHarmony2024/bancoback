...
INSERT INTO USUARIO 
(NOME, SOBRENOME, SENHA, EMAIL_LOGIN, TELEFONE, CPF, ENDERECO, N_RESIDENCIAL, BAIRRO, COMPLEMENTO_RESI, CEP, CIDADE, ESTADO, DATA_DE_NASCIMENTO, SEXO, CONF_SENHA)
VALUES 
('João', 'Silva', '$2a$10$NvzUJ8fpFuwctlNubaxo5.ymILO8Vo0OIK/O1AAQXhPyv.bITtaw6', 'joao.silva@email.com', '912345678', '12345678909', 'Rua das Flores', 123, 'Centro', 'Apto 101', '12345678', 'Lisboa', 'Lisboa', '1990-01-01', 'MASCULINO', '$2a$10$NvzUJ8fpFuwctlNubaxo5.ymILO8Vo0OIK/O1AAQXhPyv.bITtaw6');

INSERT INTO PRESTADOR 
(NOME_COMERCIAL, CNPJ, ID_USUARIO, ID_CATEGORIA, ID_SERV)
VALUES 
('João Serviços', '04118919000135', 12, 2, 1);
