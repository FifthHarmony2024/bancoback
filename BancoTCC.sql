...
ALTER TABLE PEDIDO ADD ID_AGENDA INT NOT NULL;

ALTER TABLE PEDIDO ADD CONSTRAINT FK_PEDIDO_AGENDA FOREIGN KEY (ID_AGENDA) REFERENCES AGENDA(ID_AGENDA);
...
ALTER TABLE AGENDA ADD DT_AGENDAMENTO DATE NOT NULL DEFAULT '2024-01-01';
ALTER TABLE AGENDA ADD HR_AGENDAMENTO TIME NOT NULL DEFAULT '00:00:00';
ALTER TABLE AGENDA ADD VL_ORC DECIMAL(10, 2) NOT NULL DEFAULT 0.00;
ALTER TABLE AGENDA ADD NOME_CLIENTE VARCHAR(50);
ALTER TABLE AGENDA ADD ENDERECO VARCHAR(255);
ALTER TABLE AGENDA ADD CIDADE VARCHAR(255);
ALTER TABLE AGENDA ADD BAIRRO VARCHAR(255);
ALTER TABLE AGENDA ADD NUM_RESIDENCIAL INT;


ALTER TABLE AGENDA
ADD TIPO_DIA NVARCHAR(10) CHECK (TIPO_DIA IN ('TRABALHO', 'FOLGA')) NOT NULL DEFAULT 'TRABALHO';
...
DELETE FROM CHAT 
WHERE ID_USUARIO_REMETENTE  = 45 
   OR ID_USUARIO_DESTINATARIO = 46;
