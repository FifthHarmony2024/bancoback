...
ALTER TABLE USUARIO
ADD CODIGO_CONFIRMACAO VARCHAR(4);

ALTER TABLE USUARIO
ADD DATA_EXPIRACAO_CODIGO VARCHAR(40);
...
ADD ID_USUARIO_PRESTADOR INT NOT NULL,
    ID_USUARIO_CLIENTE INT NOT NULL;

ALTER TABLE AGENDAMENTO
ADD CONSTRAINT FK_AGENDAMENTO_PRESTADOR
FOREIGN KEY (ID_USUARIO_PRESTADOR) REFERENCES USUARIO(ID_USUARIO);

ALTER TABLE AGENDAMENTO
ADD ID_USUARIO INT NOT NULL;

ALTER TABLE AGENDAMENTO
ADD NOME_CLIENTE VARCHAR(50);
...
ALTER TABLE AGENDAMENTO
ADD ID_AGENDA INT NOT NULL;

ALTER TABLE AGENDAMENTO
DROP CONSTRAINT FK_AGENDAMENTO_AGENDA;

ALTER TABLE AGENDAMENTO
ADD CONSTRAINT FK_AGENDAMENTO_AGENDA
